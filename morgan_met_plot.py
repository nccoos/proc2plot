#!/usr/bin/env python
# Last modified:  Time-stamp: <2010-03-24 16:58:08 haines>
"""morgan_met_plot"""
...
print 'morgan_met_plot2 ...'
prev_month, this_month, next_month = procutil.find_months(procutil.this_month())
#ncFile1='/seacoos/data/nccoos/level1/morgan/met/morgan_met_2008_01.nc'
#ncFile2='/seacoos/data/nccoos/level1/morgan/met/morgan_met_2008_02.nc'

ncFile1='/seacoos/data/nccoos/level1/morgan/met/morgan_met_'+prev_month.strftime('%Y_%m')+'.nc'
ncFile2='/seacoos/data/nccoos/level1/morgan/met/morgan_met_'+this_month.strftime('%Y_%m')+'.nc'
...
ax.set_xlabel('MORGAN BAY WIND -- Last 30 days from ' + last_dt_str)
...
# save figure
savefig('/home/haines/rayleigh/img/morgan_met_last30days.png')
...
ax.set_xticklabels([])
ax.set_xlabel('MORGAN BAY WIND -- Last 7 days from ' + last_dt_str)
...
savefig('/home/haines/rayleigh/img/morgan_met_last07days.png')
...
ax.set_xticklabels([])
ax.set_xlabel('MORGAN BAY WIND -- Last 24 hours from ' + last_dt_str)
...
savefig('/home/haines/rayleigh/img/morgan_met_last01days.png')
